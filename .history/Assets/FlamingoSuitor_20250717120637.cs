...
public class FlamingoSuitor : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            StartCoroutine(WelcomeDecisionRoutine());
        }
    }

    IEnumerator WelcomeDecisionRoutine()
    {
        ...
        // Pause for a decision-making moment
        ...
        else
        {
            ...
            ResetToIdle();
            flamingoWelcomed = false; // Optional: allow another chance later
        }
    }
